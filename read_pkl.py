...
file_path = '/nfs/hpc/share/sail_on3/TestsForPaper/Jan2024_EWC/RetrainingWithEWC/logs/resizepad=224/none/normalized/end-to-end-trainer/lr=0.001/label_smoothing=0.00/training.pkl'
...
# Save the figures
plt.savefig('/nfs/hpc/share/sail_on3/TestsForPaper/Jan2024_EWC/RetrainingWithEWC/logs/resizepad=224/none/normalized/end-to-end-trainer/lr=0.001/label_smoothing=0.00/training_curves.png', dpi=300)  # Save as a PNG file with 300 dpi
