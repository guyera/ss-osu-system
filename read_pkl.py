...
# training_file_path = '/nfs/hpc/share/sail_on3/TestsForPaper/Jan2024_Corrected_Normalization/End-to-End-102-ClassBalancing_2/logs/resizepad=224/none/normalized/end-to-end-trainer/lr=0.001/label_smoothing=0.00/training.pkl'
...
training_file_path = '/nfs/hpc/share/sail_on3/TestsForPaper/Jan2024_Corrected_Normalization/EWC_Batched_logit_layer_only_1000_1e-4/logs/resizepad=224/none/normalized/logit-layer-classifier-trainer/lr=0.0001/label_smoothing=0.00/training.pkl'
...
validation_file_path = '/nfs/hpc/share/sail_on3/TestsForPaper/Jan2024_Corrected_Normalization/EWC_Batched_logit_layer_only_1000_1e-4/logs/resizepad=224/none/normalized/logit-layer-classifier-trainer/lr=0.0001/label_smoothing=0.00/validation.pkl'
...
plt.tight_layout()
plt.savefig('combined_plotsEWC.png', dpi=300)
