...
def score_tests(test_dir, sys_output_dir, session_id, class_file_reader, log_dir,
    ...
    import pathlib 
    test_ids = []
    test_ids = ['OND.101.000', 'OND.102.000', 'OND.103.000', 'OND.106.000', 
    'OND.10700.000','OND.10701.000','OND.10702.000','OND.10704.000',
    'OND.10710.000', 'OND.10711.000', 'OND.10712.000', 'OND.10713.000', 'OND.10716.000']
        ...
        for test_id in test_ids:
            if 'OND' in test_id and '100.000' not in test_id:
                ...
                with open(log_dir / f'{test_id}.log', 'w') as log:
                            score_test(test_id, metadata, test_df[-29:], detect_lines, class_lines, class_file_reader,
                                    log, summary, stats)
