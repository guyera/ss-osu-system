...
if __name__ == "__main__":
    ...
    assert ((not args.distributed) or 
        ...
        TopLevelApp.ClassifierTrainer.episodic_memoery_train, \
        TopLevelApp.ClassifierTrainer.ewc_train])),\
        'Only end-to-end, logit_layer, ewc_logit_layer_train, and ewc_train, episodic_memoery_train training are supported in distributed mode'
